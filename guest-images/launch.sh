...
install_x86() {
    ...
    sleep 2
    sudo apt -y install wget git cmake vim bison build-essential default-libmysqlclient-dev libmariadb-dev libncurses-dev libssl-dev pkg-config liblua5.3-dev
}
